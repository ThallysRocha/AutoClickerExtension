(()=>{
    let intervalId;
    //import {mouse,keyboard}  require("jsautogui");
                    ...
                    function click() {
                        ...
                        if(!neverStop){
                            if(i < repetitions){
                                ...
                                let matchMessageField = document.querySelector("#s186687172")
                        
                                if(matchMessageField){//deu match
                                    let sendMessage = document.querySelector('button[type="submit"]')
